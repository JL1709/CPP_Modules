...
/*   Updated: 2021/12/15 08:18:46 by julian           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(std::string const &target)						//function overriding
{
	std::cout << "attack() called from class ScavTrap:" << std::endl;
	ClapTrap::attack(target);											//to call attack() of class ClapTrap
}
